...
function items(text: string): TranscriptItem[] {
  return [
    { key: "a", kind: "assistant", text },
    { key: "u", kind: "user", text },
    { key: "e", kind: "error", message: text },
    { key: "b", kind: "banner", model: text, workspace: text, version: text },
    {
      key: "t1",
      kind: "tool",
    ...
    { key: "n", kind: "notice", reason: "aborted", turns: 2 },
    { key: "l", kind: "elapsed", ms: 61_000, at: Date.now() },
